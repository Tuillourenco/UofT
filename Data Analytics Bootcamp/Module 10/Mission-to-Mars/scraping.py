...
# Let's define this function as "scrape_all"
def scrape_all():
...
# revisit that code and insert it into a function.
...
# The code to scrape the featured image
...
# The code to scrape the Mars Facts.
def mars_facts():
